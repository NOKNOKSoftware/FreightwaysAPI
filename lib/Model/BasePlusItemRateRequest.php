...
/**
 * BasePlusItemRateRequest Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BasePlusItemRateRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BasePlusItemRateRequest';
...
'total_weight' => 'getTotalWeight'    ];
     ...
     * Sets total_items
     *
     * @param int $total_items Total number of items included in the base plus consignment.
     *
     * @return $this
     */
     ...
     * Sets total_volume
     *
     * @param double $total_volume Volume of all items in cubic meters (m3).
     *
     * @return $this
     */
     ...
     * Sets total_weight
     *
     * @param double $total_weight Weight of all items in kilograms (kg).
     *
     * @return $this
     */
